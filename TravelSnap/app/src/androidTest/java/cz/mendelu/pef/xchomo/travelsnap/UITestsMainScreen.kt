...
import cz.mendelu.pef.xchomo.travelsnap.fake.MockMainScreenViewModel
...
class UITestsMainScreen {
    ...
    fun test_mainScreen_displaysFloatingActionButton() {
        ...
        composeRule.onNodeWithText(PlaceTag).assertExists().assertIsDisplayed()
    }
    ...
    fun test_mainScreen_listItemsDisplayed() {
        launchMainScreenWithNavigation()
        with(composeRule) {
            onNodeWithText(ListTag).assertIsDisplayed()
        }
    }
